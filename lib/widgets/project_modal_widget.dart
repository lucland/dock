    ...
    return BlocBuilder<ProjectCubit, ProjectState>(
      builder: (context, state) {
        return AlertDialog(
          ...
          title:
              const Text('Adicionar Projeto'), // You can make this dynamic as needed
          content: SizedBox(
            width: 800,
              ...
              child: Column(
                ...
                children: [
                  ...
                  CalendarPickerWidget(
                    ...
                    controller: TextEditingController(
                      text: '${state.startDate!.day}/${state.startDate!.month}/${state.startDate!.year}',
                    ),
                    onChanged: (date) =>
                  ...
                  CalendarPickerWidget(
                    ...
                    showAttachmentIcon: false,
                    controller: TextEditingController(
                      text: '${state.endDate!.day}/${state.endDate!.month}/${state.endDate!.year}',
                    ),
                    onChanged: (date) =>
